...
from .smea_sampling import sample_euler_dy, sample_euler_smea_dy, sample_euler_negative, sample_euler_dy_negative, sample_euler_dy_cfg_pp, sample_euler_smea_dy_cfg_pp
...
if smea_sampling.BACKEND == "ComfyUI":
    if not smea_sampling.INITIALIZED:
        ...
        setattr(k_diffusion_sampling, "sample_euler_dy_cfg_pp", sample_euler_dy_cfg_pp)
        setattr(k_diffusion_sampling, "sample_euler_smea_dy_cfg_pp", sample_euler_smea_dy_cfg_pp)
        ...
        SAMPLER_NAMES.append("euler_dy_cfg_pp")
        SAMPLER_NAMES.append("euler_smea_dy_cfg_pp")
